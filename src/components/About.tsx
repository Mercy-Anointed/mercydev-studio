        ...
        >
          ...
          <div>
            ...
            <p style={{ color: 'var(--text2)', fontWeight: 400, lineHeight: 1.75, marginBottom: '1rem' }}>
              I&apos;m a fullstack developer based in Port Harcourt with a love for building things that feel just right.
              Not just functional - but genuinely enjoyable to use.
            </p>

            <p style={{ color: 'var(--text2)', fontWeight: 400, lineHeight: 1.75, marginBottom: '1.5rem' }}>
              From small business websites to complex web apps, I bring both technical precision and creative energy to every
              project. When I&apos;m not coding, I&apos;m probably thinking about better ways to do it.
            </p>
