    ...
    <section id="contact" style={{ padding: '6rem 2rem' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        >
          {/* Left — info */}
          <div>
            <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '1rem' }}>Ready when you are.</h3>
            <p style={{ color: 'var(--text2)', fontSize: '0.95rem', fontWeight: 300, marginBottom: '2rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {[
                ...
                >
                  ...
                  <div>
                    <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.88rem', fontWeight: 700 }}>{method.label}</div>
                    <div style={{ fontSize: '0.78rem', color: 'var(--text3)' }}>{method.sub}</div>
                  </div>
                </a>
              ))}
            </div>
          ...
          >
            ...
            {status === 'sent' && (
              <p style={{ color: 'var(--teal)', fontSize: '0.85rem', marginTop: '1rem', textAlign: 'center' }}>
                {feedback}
              </p>
            )}
            {status === 'error' && (
